            ...
            if package in self.REQUIRED_PACKAGES:
                try:
                    ...
                    if result.returncode == 0:
                        install_results[package] = {"success": True, "output": result.stdout}
                    else:
                        install_results[package] = {"success": False, "error": result.stderr}
...
class GracefulDegradation:
    ...
    def get_fallback_strategy(self, feature: str) -> Dict[str, Any]:
        ...
        return fallback_strategies.get(feature, {
            "available": False,
...
def create_system_health_tool(db_path: str):
    ...
    def auto_repair_system() -> Dict[str, Any]:
        ...
        try:
            return {
                "success": True,
                "repair_report": monitor.auto_repair_system()
            }
        except Exception as e:
            return {
                "success": False,
