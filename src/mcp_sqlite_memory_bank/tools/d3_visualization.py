    ...
    try:
        ...
        if not graph_data["nodes"]:
            return cast(ToolResponse, {
                ...
                "details": {"filter_tables": filter_tables, "min_connections": min_connections}
            })
        ...
        interactive_features = [
            "zoom_pan", "drag_nodes", "filter_nodes", "search_content", 
            "toggle_edges", "export_image", "fullscreen_mode"
        ]
        ...
        return cast(ToolResponse, {
            ...
            "category": "VISUALIZATION_ERROR",
            "details": {"layout_algorithm": layout_algorithm, "color_scheme": color_scheme}
        })
...
def create_advanced_d3_dashboard(
    ...
    try:
        ...
        widgets = [
            "knowledge_graph", "timeline_view", "metrics_panel", 
            "table_heatmap", "search_interface", "export_controls"
        ]
        ...
        features = [
            "multi_visualization", "cross_filtering", "export_suite", 
            "responsive_design", "professional_styling"
        ]
    ...
    try:
        ...
        try:
            with db.engine.connect() as conn:
                ...
                tables_to_check = ['technical_decisions', 'project_structure', 'memories']
        ...
        if not nodes_data:
            ...
            sample_nodes = [
                {"title": "User Authentication", "category": "security", "content": "JWT-based authentication system with refresh tokens and role-based access control"},
                {"title": "Database Architecture", "category": "architecture", "content": "SQLite with memory bank pattern for agent-friendly data storage and retrieval"},
                {"title": "API Design Patterns", "category": "api", "content": "RESTful API design with explicit endpoints and comprehensive error handling"},
                {"title": "Frontend Framework", "category": "frontend", "content": "React-based UI with TypeScript for type safety and modern development practices"},
                {"title": "Testing Strategy", "category": "tools", "content": "Comprehensive test suite with unit tests, integration tests, and end-to-end testing"},
                {"title": "Performance Optimization", "category": "performance", "content": "Database indexing, query optimization, and caching strategies for scalable applications"},
                {"title": "Deployment Pipeline", "category": "tools", "content": "CI/CD pipeline with automated testing, security scanning, and deployment automation"},
                {"title": "Monitoring & Logging", "category": "performance", "content": "Application monitoring, error tracking, and structured logging for production systems"}
            ]
...
def _generate_dashboard_html(data: Dict, dashboard_type: str, include_metrics: bool, real_time: bool, widgets: List[str]) -> str:
...
def _create_semantic_clusters(raw_data: List[Dict]) -> List[Dict]:
    ...
    def extract_semantic_category(title: str, content: str) -> str:
        ...
        categories = {
            'deployment': ['deploy', 'release', 'pipeline', 'ci/cd', 'build', 'publish', 'version', 'completion'],
            'development': ['integration', 'implementation', 'coding', 'refactor', 'enhancement', 'tool', 'development'],
            'testing': ['test', 'testing', 'validation', 'verification', 'quality', 'coverage'],
            'configuration': ['config', 'setup', 'environment', 'settings', 'installation', 'server'],
            'architecture': ['architecture', 'design', 'structure', 'component', 'module', 'pattern', 'framework', 'system'],
            'database': ['database', 'sqlite', 'memory', 'storage', 'schema', 'query', 'table'],
            'api_design': ['api', 'endpoint', 'rest', 'interface', 'method', 'function'],
            'documentation': ['documentation', 'docs', 'guide', 'instruction', 'readme'],
            ...
            'error_handling': ['error', 'exception', 'handling', 'debugging', 'troubleshoot'],
    ...
    nodes_data = []
    cluster_positions = {}  # Track cluster center positions
